                    ...
                    <div className="row align-items-center justify-content-center justify-content-lg-between">
                        <div className="col-lg-6">
                            <div className="header_hero_content mt-45">
                                ...
                                <p className="wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="1.1s" style={{visibility: "visible", animationDuration: "1.3s", animationDelay: "1.1s", animationName: "fadeInUp"}}>Experienced web developer proficient in JavaScript, React, and Redux, specializing in crafting responsive designs and reusable components. With a keen eye for detail and a passion for creating seamless user experiences, I bring innovation and efficiency to every project I undertake.</p>
